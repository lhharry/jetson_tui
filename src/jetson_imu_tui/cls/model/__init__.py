...
checkpoint was trained with (``dataset/jetson_leg/label_map.json``, ids 0..10).
"""

CLASSES = [
    "stand", "walk", "turn", "jog", "rampascent", "stairascent",
    "stairdescent", "sit", "sit-to-stand", "stand-to-sit", "rampdescent",
]
